...
const freq_setting sweep_roll     = {10,       2,         2,        2,         30,       0.1f,   10.0f,  0.0f,   0.3f};
const freq_setting sweep_pitch    = {10,       2,         2,        2,         30,       0.1f,   10.0f,  0.0f,   0.3f};
const freq_setting sweep_yaw      = {10,       2,         2,        2,         30,       0.1f,   10.0f,  0.0f,   0.3f};
